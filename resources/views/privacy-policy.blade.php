...
@section('body')
    <div class="container">
        ...
        <p>A sua privacidade é importante para nós. É política do TCC PDV respeitar a sua privacidade em relação a
            qualquer informação sua que possamos coletar no site <a href=https://tcc.daagencia.com.br>TCC PDV</a>, e
        ...
        <h2>Política de Cookies TCC PDV</h2>
        ...
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o TCC PDV oferece no site e
        ...
        <ul>
            ...
            <li>B) Não divulgar conteúdo ou propaganda de natureza racista, xenofóbica, <a
                        href='https://ondeapostar.pt/' style='color: inherit;font-weight: normal;text-decoration:none;'>casas
                    de apostas</a>, pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
            </li>
            <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do TCC PDV, de seus
